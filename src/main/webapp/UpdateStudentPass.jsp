      ...
      <div class="col-7 offset-4 mb-4">
        <div class="card h-100">
          ...
          <div class="card-body">
              ...
              <form action="StudentForgottenPassUpdateDB.jsp" method="post" id="contactForm" novalidate>
          <div class="control-group form-group">
              <label>New Password:</label>
              <div class="input-group">
              <input type="password" name="pswd" class="form-control" id="studentPswd" required data-validation-required-message="Please enter your phone number.">

...
<html>
    ...
    <body>
        ...
        String msg="<head><meta charset=“UTF-8”></head><p><b>Dear "+fname+",</b> <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Your forgotten code is <b style=\"color: green\">'"+finaly+"'</b>. Please verify and access your account. <br><p style=\"color: red\">Please delete this message after login.</p></p><br><br><h3 align=\"center\">Thank You!! &#x1F60a;</h3>";
                    //sending mail
        ...
        %>
           <script>
               ...
               window.location="FacultyForgottenCodeEnter.jsp";
           </script>

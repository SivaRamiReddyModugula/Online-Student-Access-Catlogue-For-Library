    ...
    <div class="row">
      ...
      <div class="col-lg-6 mb-4">
        <div class="card h-100">
          <h4 class="card-header">BOOK ISSUE</h4>
          <div class="card-body">
            
              <form action="FactBookIssue.jsp" method="post" id="contactForm" novalidate>
      ...
      <div class="col-lg-6 mb-4">
        <div class="card h-100">
          ...
          <div class="card-body">
            <form action="FactBookReturn.jsp" method="post" id="contactForm" novalidate>
          <div class="control-group form-group">
            <div class="controls">
              <label>Book Id:</label>

    ...
    <div class="row">
      ...
      <div class="col-lg-12 mb-4">
        <div class="card h-100">
          <h4 class="card-header">Generate Reports</h4>
          <div class="card-body">
              <a class="btn btn-primary" href="BooksCountReport.jsp">Books Count</a>
              &emsp;&emsp;&emsp;&emsp;
              <a class="btn btn-primary" href="BookDetailReport.jsp">Total Book Details</a>
              &emsp;&emsp;&emsp;&emsp;
              <a class="btn btn-primary" href="FacultyReports.jsp">Faculty Reports</a>
              &emsp;&emsp;&emsp;&emsp;
              <a class="btn btn-primary" href="StudentReports.jsp">Student Reports</a>
          </div>
        </div>
      </div>

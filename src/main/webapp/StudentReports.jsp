...
<header>
  ...
  <div class="container">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="StudentReports.jsp">Student Reports</a>
      </li>
    </ol>
    ...
    <div class="row">
      ...
      <div class="col-lg-6 mb-4">
        <div class="card h-100">
          <h4 class="card-header">Generate Student Reports</h4>
          <div class="card-body">
              <a class="btn btn-primary" href="StudentDetailReport.jsp">Student Details</a>
                &emsp;&emsp;
              <a class="btn btn-primary" href="StudentIssueReport.jsp">Student Issue Details</a>
          </div>
        </div>
      </div>

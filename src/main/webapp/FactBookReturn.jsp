...
<%
    ...
    PreparedStatement ps = conn.prepareStatement("select * from factissue where bid='"+bid+"' AND status='issued'");
        ...
        if(rs.next()){ 
                ...
                if(rs3.next()){
                    ...
                    PreparedStatement ps2 = conn.prepareStatement("update factissue set status='submitted',submitted='"+oldDate+"' where bid='"+bid+"' AND status='issued'");

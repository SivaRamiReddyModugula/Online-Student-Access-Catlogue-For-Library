...
<header>
  ...
  PreparedStatement psname=conn.prepareStatement("select * from student where htno='"+htno+"'");
  ...
  <div class="container">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="ShowStudents">Show Students</a></li>
        <li class="breadcrumb-item active"><a href="SearchStudent.jsp">Search Student</a></li>
    </ol>
    ...
    <div class="row">
      ...
      <br/>
              ...
              <%
      PreparedStatement ps = conn.prepareStatement("select * from issue where htno='"+htno+"'");

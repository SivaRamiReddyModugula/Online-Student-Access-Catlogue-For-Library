<%-- 
    Document   : Update
    Created on : 5 Mar, 2020, 7:53:33 PM
  ...
  <div class="container">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">
        ...
        <a href="Update.jsp?htno=htno">Update</a>
      </li>
    </ol>
    ...
    <div class="row">
      ...
      if(rs.next()){
          session.setAttribute("htno",htno);
                  %>
      <tr><td rowspan="8"><img  src="view.jsp?htno=<%=rs.getString("htno")%>" width="200" height="200" /></td></tr>

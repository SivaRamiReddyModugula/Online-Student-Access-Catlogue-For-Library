...
<header>
  ...
  <div class="container">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active"><a href="ViewStudents.jsp">Add Students</a></li>
    </ol>
        ...
        <div class="card h-100">
          ...
          <div class="card-body">
              <table class="table-bordered table-primary">
                  ...
                  PreparedStatement ps = conn.prepareStatement("select * from student where status='waiting' and htno!=''");

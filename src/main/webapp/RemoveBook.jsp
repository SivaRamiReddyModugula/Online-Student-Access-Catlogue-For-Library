...
<header>
  ...
  <div class="container">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active"><a href="RemoveBook.jsp">Remove Book</a></li>
    </ol>
      ...
      <div class="col-lg-9 mb-4">
       ...
       <div class="col-lg-7 mb-4">
        <div class="card h-100">
          <h4 class="card-header">Remove Book</h4>
          <div class="card-body">
            
              <form action="RemoveBookDB.jsp" method="post" id="contactForm" novalidate>
                  <div class="control-group form-group">
            <div class="controls">
              <label>Book Id:</label>
              <input type="text" class="form-control" name="bid" id="name" required data-validation-required-message="Please enter your name.">
          ...
          <button type="submit" class="btn btn-primary" id="sendMessageButton">Remove</button>
        </form>
